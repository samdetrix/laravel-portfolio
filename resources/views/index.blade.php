                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h2 data-animation="fadeInUp" data-delay="100ms">SAVA CONSTRUCTIONS LTD </h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="single-featured-property mb-50 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="property-content">
                            <h5>VIHIGA</h5>
                            <p class="location"><img src="img/icons/location.png" alt="">Upper Road 3411</p>
    ...
    <section class="south-editor-area d-flex align-items-center">
        ...
        <div class="editor-content-area">
            ...
            <div class="address wow fadeInUp" data-wow-delay="750ms">
                <h6><img src="img/icons/phone-call.png" alt=""> 0716151725</h6>
                <h6><img src="img/icons/envelope.png" alt=""> skmaina@gmail.com</h6>
            </div>
